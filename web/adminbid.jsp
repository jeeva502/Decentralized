...
<body>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for Service Based Applications in Cloud&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;using Decentralized Self-Adaptation Mechanism</font>
    ...
    <div id="site_content"><br>
      <h2><font color="orange"> User bids list</h2><br>
 
                   
                     
                  
                   <table align="center" bordercolor="red" border="1">
                       <th>UserName</th><th>Application Name</th><th>Price</th><th>SSL</th>
                       <th>Latency</th>
                       <tr>
           <%
           String a=request.getParameter("det");
...
Class.forName("com.mysql.jdbc.Driver");	
 ...
 Statement st1=con.createStatement();
  ...
  ResultSet rs1=st1.executeQuery("select uname from reg "); 
  for(int i=0;rs1.next();i++)
  {
      b[i]=rs1.getString(1);
  }
 for(int i=0;rs.next()&& i<b.length;i++)
         {
     if(b[i].equals(a))
        {
%>                    

    ...
    <body>
        <div id="main">
            ...
            <div id="site_content"><br>
                <h2><font color="orange"><center><b><i> Welcome to User Account</h2><br>
                            </i></b></center>


                <form action="adminbid.jsp" method="post">
                   <center>
 <table align="center" bordercolor="red" border="1">
                        <th>User Name</th><th>Email Id</th><th>DOB</th>
                        <th>Mobile No</th><th>Address</th><th>Gender</th>
                        <tr>
                            <%
                            ...
                            %> 
                            <td><input type="radio" name="det"value="<%=rs.getString(2)%>"/><%=rs.getString(2)%></td>           
                        ...
                        <table><center>
                          <input type="submit" value="submit"/></center></table>>
                </form>

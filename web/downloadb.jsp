    ...
    <div id="site_content"><br>
      <h2><font color="orange"> Welcome to User Account</h2><br>
                   ...
                   <table align="center" bordercolor="red" border="1">
                       <th>File Id</th><th>Application Name</th><th>File Size</th><th>SSL</th><th>Latency</th>
                       <th>Amount</th>
                       <tr>
           <%
...
%>  </table>
			...
			<form action="download1.jsp">                            
                <input type="submit" value="Place a Bid for this application"/>
            </td>

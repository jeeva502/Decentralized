            ...
            <td width="400px" align='center'>
                ...
                <table width="200%" border="0" cellpadding="3px" class="htmlForm" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><input type="text" size="23" value="<%=rs.getString(2)%>" name="lname"/></td>
                    </tr>
                     
                    <tr>
                        <td align="left">Email</td>
                        <td><input type="text" size="23" value="<%=rs.getString(3)%>" name="email"></td>
                    </tr>
                    <tr>
                        <td align="left">Password</td> 
                <td><input type="password" size="23" value="<%=rs.getString(4)%>" name="pwd"></td>
                    </tr>   
                       
                      <tr>
                        <td align="left"> Date of Birth </td>
                        <td><input type="date" size="23" value="<%=rs.getString(5)%>" name="date"></td>
                    </tr>
                    <tr>
                        <td align="left">Mobile </td>
                        <td><input type="text" size="23" value="<%=rs.getString(6)%>" name="mobile"></td>
                    </tr>
                    <tr>
                        <td align="left">Address</td>
                        <td><input type="text" size="23" value="<%=rs.getString(7)%>" name="city"/></td>
                    </tr>

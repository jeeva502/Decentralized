...
Class.forName("com.mysql.jdbc.Driver");	
 ...
 ResultSet rs=st.executeQuery("select * from reg where uname='"+a+"' and id='"+b+"' and ans='"+c+"'");
 if(rs.next())
         {
%>          <form action="vm2.jsp" method="post">
            ...
            <td width="400px" align='center'>
                ...
                <table width="200%" border="0" cellpadding="3px" class="htmlForm" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><input type="text" size="23" name="fid" value="<%=(int)(Math.random()*10000)%>"></td>
                    </tr>
                     
                    <tr>
                        <td align="left">Application Name</td>
                        <td><input type="text" size="23" name="fn"></td>
                    </tr>
                   <tr>
                        <td align="left">Password</td> 
                        <td><input type="password" size="23" name="pwd"></td>
                   </tr>   
                    <tr>
                        <td align="left">SSL </td>
                        <td><input type="text" size="23" name="ssl" placeholder="Yes/No"></td>
                    </tr>
                    <tr>
                        <td align="left">Latency </td>
                        <td><input type="text" size="23" name="lat"></td>
                    </tr>
                       
                      <tr>
                        <td align="left"> Card Type </td>
                        <td><input type="text" size="23" name="ct" placeholder="Debit/Credit"></td>
                    </tr>
                    <tr>
                        <td align="left">Amount </td>
                        <td><input type="text" size="23" name="amt"></td>
                    </tr>
                    <tr>
                        <td align="left">Choose Application</td>
                        <td><input type="file" size="23" name="file"></td>
                    </tr>
                    <tr>
                        <td align="left">Resource</td>
                        <td><input type="text" size="23" name="src" value="<%=(String)session.getAttribute("src")%>" readonly=""></td>
                    </tr>
                     <tr>
                        <td align="left">Provider Name</td>
                        <td><input type="text" size="23" name="pn" value="<%=(String)session.getAttribute("provide")%>" readonly=""></td>
                    </tr>

...
<body>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for Service Based Applications in Cloud&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;using Decentralized Self-Adaptation Mechanism</font>
    ...
    <div id="site_content"><br>
     <h2><font color="orange">Enter Your Bids</h2><br>
 
                    
               <form action="download3.jsp" method="post">
                   <table align="center">
                       <tr>
                        <td align="left">User Name</td> 
                <td><input type="text" size="23"  name="select2"></td>
                    </tr>
                    <tr>
                        <td align="left">Enter Application Name</td> 
                <td><input type="text" size="23"  name="select"></td>
                    </tr>   
                    <tr>
                    ...
                    <tr>
                        <td align="left">Enter Your Application Latency</td> 
                <td><input type="text" size="23"  name="select4"></td>
                    </tr> 
                    <tr>
                        <td align="left">Enter Your Application Amount</td> 
                <td><input type="text" size="23"  name="select1"></td>
                    </tr>
                    
        <tr bgcolor="" align='center'>
            <td>&nbsp;</td> 
            <td colspan="2">
                <input type="submit" value="BidNow"/>&nbsp;&nbsp;

...
<body>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for Service Based Applications in Cloud&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;using Decentralized Self-Adaptation Mechanism</font>
    ...
    <div id="site_content"><br>
      ...
      <%
      String a4=request.getParameter("select");
      session.setAttribute("provide", a4);
      if(a4.equals("India"))
         {
        %>
        <table align="center">
            <tr align="center">
                ...
                <tr>
                <td><a href="vm.jsp?Resource1"><font size="4">Resource1</a></td></tr>
                <tr><td><a href="vm.jsp?Resource2"><font size="4">Resource2</a></td></tr>
               <tr> <td><a href="vm.jsp?Resource3"><font size="4">Resource3</a></td></tr>
               </tr>
               </table>
                <%
                }
else if(a4.equals("England"))
{
    %>
        <table align="center">
            <tr align="center">

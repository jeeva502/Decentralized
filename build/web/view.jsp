...
Class.forName("com.mysql.jdbc.Driver");	
 ...
 ResultSet rs=st.executeQuery("select * from reg where uname='"+a+"'");
 if(rs.next())
         {
%>
        ...
        <tr bgcolor="#FFFFDD">
            ...
            <td width="400px" align='center'>
                <div class="formHeading" align="center">User Account View</div>
                ...
                <table width="200%" border="0" cellpadding="3px" class="htmlForm" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><input type="text" size="23" value="<%=rs.getString(2)%>" readonly=""/></td>
                    </tr>
                     
                    <tr>
                        <td align="left">Email</td>
                        <td><input type="text" size="23" value="<%=rs.getString(3)%>" readonly=""></td>
                    </tr>
                    <tr>
                        <td align="left">Password</td> 
                        <td><input type="password" size="23" value="<%=rs.getString(4)%>" readonly=""></td>
                    </tr>   
                       
                      <tr>
                        <td align="left"> Date </td>
                        <td><input type="date" size="23" value="<%=rs.getString(5)%>" readonly=""></td>
                    </tr>
                    <tr>
                        <td align="left">Mobile </td>
                        <td><input type="text" size="23" value="<%=rs.getString(6)%>" readonly=""></td>
                    </tr>
                    <tr>
                        <td align="left">Address</td>
                        <td><input type="text" size="23" value="<%=rs.getString(7)%>" readonly=""/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="gender" value="male" readonly=""/><%=rs.getString(8)%> 
